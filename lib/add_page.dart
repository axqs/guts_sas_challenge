...
class _AddPageState extends State<AddPage> {
  ...
  List<ListItem> shoppingItems = List<ListItem>.generate(
      20, (int index) => ListItem("Item " + index.toString(), DateTime.now()));
            ...
            new ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ListPage(title: "Shopping List")),
                );
              },
            ...
            new ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => FridgePage(title: "Fridge Page")),
                );
              },
              trailing: new Icon(Icons.arrow_right),
            ),
